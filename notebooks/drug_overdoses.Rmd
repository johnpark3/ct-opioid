...
drugs_ts %>%
  ...
  labs(x = NULL, title = "Age-adjusted overdose death rate per month per 1 million",
       subtitle = "6-month rolling average by cluster, 2012–2018") +
  theme_light() +
...
write_csv(annual_15_18, "../output_data/annual_avg_drug_deaths_100k_2015_2018.csv")
```